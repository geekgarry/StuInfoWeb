...
/**
 * Servlet implementation class QueryStuByClass
 */
@WebServlet("/QueryStuByClass")
public class QueryStuByClass extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		UniversalPage universalPage=dao.universalPage(user,pageNo,pagesize);
