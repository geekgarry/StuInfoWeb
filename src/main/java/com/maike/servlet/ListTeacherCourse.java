...
/**
 * Servlet implementation class ListTeacherCourse
 */
@WebServlet("/ListTeacherCourse")
public class ListTeacherCourse extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		UniversalPage universalPage=dao.universalPage(typeString, keyString,teacherid,pageNo, pagesize);
		/*将list集合装换成json对象*/
