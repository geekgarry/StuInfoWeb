...
/**
 * Servlet implementation class IsExistTeacherAccount
 */
@WebServlet("/IsExistTeacherAccount")
public class IsExistTeacherAccount extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<HashMap<String,Object>> list=dao.queryteacherinfo(name);
