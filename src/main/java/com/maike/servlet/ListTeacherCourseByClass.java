...
/**
 * Servlet implementation class ListTeacherCourseByClass
 */
@WebServlet("/ListTeacherCourseByClass")
public class ListTeacherCourseByClass extends HttpServlet {
     ...
     */
    public ListTeacherCourseByClass() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		UniversalPage universalPage=dao.universalPage(stuclass,pageNo, pagesize);
		/*将list集合装换成json对象*/
