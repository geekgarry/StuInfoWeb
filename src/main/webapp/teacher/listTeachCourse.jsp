<%@page import="com.maike.entity.TeacherCourse"%>
...
<html>
  <head>
    ...
    <title>My JSP 'listTeachCourse.jsp' starting page</title>
 ...
 %>
  <body>
    ...
    <span class="title">课程小节管理&gt;&gt;</span>
    <em>
    <input value="添加新节" class="input-button" onclick="openDialog()" type="button"> 
    </em>
    </div>
  	<table id="travel">
    <thead>
    ...
    <div id="light" class="white_content" align="center">
            ...
            <form method="post" action="UploadCourseDetail" name="addcoursedetail" enctype="multipart/form-data" onsubmit="return check(this)"><!-- enctype="multipart/form-data" -->
			 <table border="1" class="bordered" id="bordered">
			    <tr>
			    	<th colspan="2" colspan="2">课程内容资源上传</th>
			    </tr>
			    <tr>
			    	<td>课程内容</td>
			    	<td>
			    	...
			    	<input type="text" name="teachcourseid" id="teachcourseid" value="<%=id %>" style="display: none;">
			    	<textarea rows="4" cols="40" name="coursecontent" id="coursecontent"></textarea>
			    	</td>
			    </tr>
			    <tr>
			    	<td>课程资源</td>
			    	<td><input type="file" name="courseresource" id="courseresource" ></td>
			    </tr>
			    <tr>
			    	<td colspan="2">
			    		<div id="errormsg"></div>
			    		<input type="submit" value="添加" class="universalbtn" onclick="addcoursedetail()">
    ...
    <script type="text/javascript">
		...
		function convertURL(url){  
          ...
          $.each(datalist,function(){
				...
				"<td><span class='STYLE1'><a class='addscore' href='QueryStudent?stuclass="+this.classofteach+"&subjectid="+this.subjectid+"&courseteam="+this.courseteam+"'>添加成绩</a></span></td></tr></tbody>";
				/* if(coursestatus=="0"){
